...
description: GitHub workflows via the gh CLI and GitHub MCP for issues, PRs, reviews, branches, releases, repos, and CI. Use for any GitHub or repository management task.
---

# GitHub Workflows

Handle issues, pull requests, code reviews, branches, releases, repos, and CI status using the `gh` CLI and the GitHub MCP tools.

## Tooling priority

Prefer the `gh` CLI. In case of repeated failures, use the GitHub MCP web interface for inspection and manual actions.
